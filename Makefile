am_main1:
	...
	gcc -I ./include/ -L ./lib/ -Wl,-rpath,./lib/ ./examples/am_main1.c ./src/AM.c ./src/file_info.c ./src/Scan.c ./src/stack.c ./src/insert_lib.c -lbf -o am_main1 -g

am_main2:
	@echo " Compile am_main2 ...";
	gcc -I ./include/ -L ./lib/ -Wl,-rpath,./lib/ ./examples/am_main2.c ./src/AM.c ./src/file_info.c-lbf ./src/Scan.c -o am_main2 -g

am_main3:
	@echo " Compile am_main3 ...";
	gcc -I ./include/ -L ./lib/ -Wl,-rpath,./lib/ ./examples/am_main3.c ./src/AM.c ./src/file_info.c ./src/Scan.c -lbf -o am_main3 -g
